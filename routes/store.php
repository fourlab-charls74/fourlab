...
Route::group(['middleware' => 'store','as' => 'store.', 'namespace' => 'store'], function() {
    ...
    Route::prefix("standard")->namespace('standard')->group(function () {
        ...
        Route::get('std07/search-store-fee', 'std07Controller@search_store_fee');
        ...
        Route::get('std07/changeUseYn/{store_cd?}/{use_yn?}','std07Controller@change_use_yn');
    ...
    Route::prefix("product")->namespace('product')->group(function () {
		...
		Route::put('prd05/batch-update', 'prd05Controller@batch_update');
		Route::post('prd05/batch-getgoods', 'prd05Controller@get_goods');
    ...
    Route::prefix("cs")->namespace('cs')->group(function () {
        ...
        Route::get('cs02/download','cs02Controller@download'); // 명세서출력
    ...
    Route::prefix("stock")->namespace('stock')->group(function () {
		...
		Route::get('stk32/reply-msg/{msg_cd?}', 'stk32Controller@reply_msg');
		Route::put('stk32/update-check-yn', 'stk32Controller@update_check_yn');
		...
		Route::get('stk35/download','stk35Controller@download'); // 명세서출력
		Route::get('stk35/show/{sr_cd?}','stk35Controller@show');
		Route::get('stk35/search-return-products','stk35Controller@search_return_products'); // 기존에 반품등록된 상품목록 조회
		Route::put('stk35/save','stk35Controller@save'); // 반품요청
		Route::put('stk35/update','stk35Controller@update'); // 반품수정
		Route::delete('stk35/del-return','stk35Controller@del_return'); // 반품 삭제
		...
		Route::get('stk36/total-search', 'stk36Controller@total_search');
    ...
    Route::prefix("order")->namespace('order')->group(function () {
		...
		Route::get('ord02/search-reject-list/{product_code?}','ord02Controller@search_reject_list');
    ...
    Route::prefix("sale")->namespace('sale')->group(function () {
		...
		Route::get('sal66','sal66Controller@index');
		Route::get('sal66/search','sal66Controller@search');
		...
		Route::get('sal68', 'sal68Controller@index'); // 매장브랜드별매출분석
		Route::get('sal68/search','sal68Controller@search');

        Route::get('sal09','sal09Controller@index');
        Route::get('sal09/search','sal09Controller@search');
		...
		Route::get('sal51', 'sal51Controller@index');
		Route::get('sal51/search', 'sal51Controller@search');
		...
		Route::get('sal53', 'sal53Controller@index');
		Route::get('sal53/search', 'sal53Controller@search');
		...
		Route::get('sal55', 'sal55Controller@index');
		Route::get('sal55/search', 'sal55Controller@search');
		
        //판매처별 매출 통계
        Route::get('sal26', 'sal26Controller@index');
        Route::get('sal26/search', 'sal26Controller@search');

		Route::get('sal56', 'sal56Controller@index');
		Route::get('sal56/search', 'sal56Controller@search');

		//판매처별 매출 통계(신)
		Route::get('sal38', 'sal38Controller@index');
		Route::get('sal38/search', 'sal38Controller@search');
		...
		Route::get('sal64','sal64Controller@index');
		Route::get('sal64/search','sal64Controller@search');
