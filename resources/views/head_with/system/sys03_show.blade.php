            ...
            <div class="card shadow">
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="table-responsive">
                        <div id="div-gd" style="height:550px;width:100%;" class="ag-theme-balham"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        let data = '';
        gx.Request('/head/system/sys03/' + code + '/search', data);
    }
</script>
