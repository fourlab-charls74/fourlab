        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                          ...
                          <div class="flax_box">
                              <select name='state' class="form-control form-control-sm">
                                  ...
                                  @foreach ($qna_states as $qna_state)
                                      <option value='{{ $qna_state->code_id }}' @if($qna_state->code_id == '0')selected @endif>
                                          {{ $qna_state->code_val }}
                                      </option>
                                  @endforeach
                              </select>
                ...
                <div class="row">
                    <div class="col-lg-4 inner-td">
                        <div class="form-group">
                            <label for="formrow-firstname-input">업체</label>
                            <div class="flax_box">
                                <input type='text' class="form-control form-control-sm search-all search-enter" name='com_nm' value=''>
                            </div>
                        </div>
                    </div>
    ...
    var columns = [
        ...
        {headerName: "제목", field: "subject",width:500,
            cellRenderer: function(params) {
                return '<a href="/head/partner/pat02/' + params.data.no +'" rel="noopener">'+ params.value+'</a>'
            }},
        {headerName: "업체명", field: "com_nm"},
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request('/head/partner/pat02/search', data);
    }
</script>
