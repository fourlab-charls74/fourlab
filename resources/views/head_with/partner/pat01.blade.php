        ...
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                ...
                <div class="flax_box">
                    ...
                    <a href="/head/partner/pat01/create" class="btn btn-sm btn-outline-primary shadow-sm pl-2 mr-1"><i class="bx bx-plus fs-16"></i> 추가</a>
    ...
    var columns = [
        ...
        {headerName: "제목", field: "subject",width:400,
            cellRenderer: function(params) {
                return '<a href="/head/partner/pat01/' + params.data.idx +'" rel="noopener">'+ params.value+'</a>'
            }},
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request('/head/partner/pat01/search', data);
    }
