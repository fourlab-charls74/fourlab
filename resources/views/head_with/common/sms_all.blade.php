                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="flax_box justify-content-end">
                                    <textarea id="msg" cols="30" rows="5" class="form-control form-control-sm">여기에 메시지를 입력해주십시오.</textarea>
                                    <div class="pt-1">
                    ...
                    <div class="row">
                        <div class="col text-center mt-3">
                            <!-- <a href="#" id="search_sbtn" class="btn btn-sm btn-primary shadow-sm">메시지일괄입력</a> -->
                            <a href="#" id="search_sbtn" class="btn btn-sm btn-primary shadow-sm add-msg-btn">추가</a>
                            <a href="#" id="search_sbtn" class="btn btn-sm btn-primary shadow-sm template-btn">템플릿 선택</a>
...
const snedColumn = [
    ...
    {field: "name", headerName: "수신자"},
    {field: "phone", headerName: "휴대폰번호"},
    {field: "msg", headerName: "메시지", width:250 },
    {field: "byte", headerName: "바이트"}
];
...
$('.delete-btn').click((e) => {
    ...
    sendGx.getSelectedRows().forEach((selectedRow, index) => {
        sendGx.gridOptions.api.updateRowData({remove: [selectedRow]});
    });
});
