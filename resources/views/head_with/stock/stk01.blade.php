...
@section('content')
    ...
    <script language="javascript">
        ...
        var columns= [
                ...
                {field:"style_no" ,headerName:"스타일넘버",pinned:'left', width:80, cellStyle: {'text-align':'center'}, cellClass: 'hd-grid-code'},
                {field:"goods_type_nm",headerName:"상품구분",pinned:'left',width:60, cellStyle: {...StyleGoodsType, 'text-align': 'center'}, cellClass: 'hd-grid-code'},
                {field:"is_unlimited_nm",headerName:"재고구분",pinned:'left',width:60, cellStyle: {'text-align': 'center'}, cellClass: 'hd-grid-code'},
