...
@section('content')
                                ...
                                <div class="form-inline inline_select_box">
                                    <div class="form-inline-inner input-box w-100">
                                        <div class="form-inline inline_btn_box">
                                            <select id="com_cd" name="com_cd" class="form-control form-control-sm select2-sup_company"></select>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        const add = () => {
            const url = '/head/stock/stk11/show';
        ...
        const clickInvoiceNo = (stock_no) => {
            const cmd = 'edit';
            const url = `/head/stock/stk11/show?cmd=${cmd}&stock_no=${stock_no}`;
