                        ...
                        <div class="row">
							<div class="col-12">
								<div class="table-box-ty2 mobile">
									<table class="table incont table-bordered" width="100%" cellspacing="0">
										...
										<tbody>
											<tr>
                                                ...
                                                <td>
													<div class="flax_box">
														<select name="buffer_cnt" class="form-control form-control-sm">
									...
									<div style="text-align:right;color:#0000FF;">
										XMD 출고관리 > 총재고현황 : 엑셀다운로드 <br>
										XMD 재고파일은 RT 매장의 재고만 등록 ( 물류, 온라인재고, 아울렛 재고 제외 )
									</div>
		...
		<div class="card shadow mb-4 last-card pt-2 pt-sm-0">
			<div class="card-body">
				...
				<div class="table-responsive">
					<div id="div-gd" style="height:calc(100vh - 320px);width:100%;" class="ag-theme-balham"></div>
				</div>
			</div>
		</div>
...
<script language="javascript">
	var columnDefs = [
		...
		{headerName:"TAG가",		field:"goods_sh",	width:80},
		{headerName:"현재가",		field:"price",		width:80},
		{headerName:"원가",			field:"wonga",		width:80},
        {headerName:"기획",
            children: [
                {headerName: "수량", field: "qty1",		width:64},
                {headerName: "합계", field: "amt1",		width:64},
			]
		},
        {headerName:"입고",
            children: [
                {headerName: "수량", field: "qty2",		width:64},
                {headerName: "합계", field: "amt2",		width:64},
			]
		},
        {headerName:"출고",
            children: [
                {headerName: "수량", field: "qty3",		width:64},
                {headerName: "합계", field: "amt3",		width:64},
			]
		},
        {headerName:"반품",
            children: [
                {headerName: "수량", field: "qty4",		width:64},
                {headerName: "합계", field: "amt4",		width:64},
			]
		},
        {headerName:"판매",
            children: [
                {headerName: "수량", field: "qty5",		width:64},
                {headerName: "합계", field: "amt5",		width:64},
			]
		},
        {headerName:"로스",
            children: [
                {headerName: "수량", field: "qty6",		width:64},
                {headerName: "합계", field: "amt6",		width:64},
			]
		},
        {headerName:"재고",
            children: [
                {headerName: "매장", field: "store_qty",	width:64},
                {headerName: "창고", field: "bonsa_qty",	width:64},
                {headerName: "총합", field: "tot_qty",		width:64},
			]
		},
	];
...
<script type="text/javascript" charset="utf-8">
	...
	function Save() 
	{
		...
		if( ret )
		{
			...
			$.ajax({
				async: true,
				type: 'put',
				url: '/head/stock/stk35/show',
				data: {
					data : JSON.stringify(GridData),
					buffer_cnt : $('select[name="buffer_cnt"]').val()
				},
	...
	function Upload(){
		...
		$.ajax({
			url: '/head/stock/stk35/upload', // point to server-side PHP script
