        ...
        <div class="card-body pt-3">
            <div class="card-title">
                <div class="filter_wrap">
                    ...
                    <div class="fr_box">
                        <div class="font-weight-light">
                            <span class="mr-2">총 입고 <b id="imp_tot" style="color: blue;">0</b>개</span>
                            <span class="mr-2">|</span>
                            <span class="mr-2">총 출고 <b id="exp_tot" style="color: red;">0</b>개</span>
                            <span class="mr-2">|</span>
                            <span>차감재고 <b id="minus_qty" style="color: blue;">0</b>개</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script language="javascript">
    ...
    var columns = [
        ...
        {field: "opt_val", headerName: "옵션", width: 180, sortable: "true"},
    ...
    function ViewOptions(options,qty,wqty,sales){
        ...
        if (gridOptDiv !== null) {
            ...
            if(options[1].length == 0){
                ...
                row['opt_tot'] = Object.keys(qty).reduce((a,c) => a+qty[c], 0) + " / " + Object.keys(wqty).reduce((a,c) => a+wqty[c], 0) + " / " + Object.keys(sales).reduce((a,c) => a+parseInt(sales[c]), 0);
                rows.push(row);
            } else {
