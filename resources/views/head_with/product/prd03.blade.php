        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 inner-td">
=======
	<h3 class="d-inline-flex">상품도매[개발중]</h3>
	<div class="d-inline-flex location">
		<span class="home"></span>
		<span>/ 상품도매</span>
	</div>
...
<<<<<<< HEAD
    ...
    let columns = [
        ...
        { field: "goods_no", headerName: "상품번호", width: 90, type:"HeadGoodsNameType", pinned: 'left' },
        ...
        { field: "img", headerName: "이미지", width: 100, type:'GoodsImageType', pinned: 'left', hide: true },
        { field: "img_url", headerName: "이미지_url", width:75, hide: true },
        { field: "goods_nm", headerName: "상품명", width: 100, pinned: 'left' },
...
=======
	...
	let columns = [
		{ headerName: '', headerCheckboxSelection: true, checkboxSelection: true, width: 40, cellStyle: {"background":"#F5F7F7"}, pinned: 'left' },
		{ field: "goods_no", headerName: "상품번호", width: 72, type:"HeadGoodsNameType", pinned: 'left' },
		{ field: "style_no", headerName: "스타일넘버", width: 100, pinned: 'left' },
		...
		{ field: "brand_nm", headerName: "브랜드", pinned: 'left' },
		{ field: "img", headerName: "이미지", width: 60, type:'GoodsImageType', pinned: 'left', hide: true },
		{ field: "img_url", headerName: "이미지_url", width:75, hide: true },
		{ field: "goods_nm", headerName: "상품명", width: 180, pinned: 'left' },

		{ 
			headerName: "재고수", 
			children: [
				{ field: "qty", headerName: "온라인", type: 'numberType', width: 60 },
				{ field: "wqty", headerName: "보유", type: 'numberType', width: 60 },
			] 
		},
		{ field: "price", headerName: "판매가", type: 'numberType', width: 60 },
		{ field: "wonga", headerName: "원가", type: 'numberType', width: 60, cellRenderer: (params) => `<a href="#" onclick="openWongaPopup(event, ${params.data.goods_no}, ${params.data.goods_sub})">${params.value}</a>` },
		{ field: "margin", headerName: "원가대비 마진율", type: 'numberType', width: 100 },
	];
	...
	group_columns.forEach(col => {
		columns.push({ 
			...
			children: [
				{ field: `group_${col.group_no}`, headerName: "그룹코드", hide: true },
				{ field: `group_${col.group_no}_margin`, headerName: "그룹마진", type: 'numberType', width: 72 },
				{ field: `group_${col.group_no}_price`, headerName: "판매가", type: 'numberType', cellStyle: styleOfWholeSalePrice, width: 60 },
				{ field: `group_${col.group_no}_ratio`, headerName: "마진율", type: 'numberType', cellStyle: styleOfMarginRatio, width: 60 },
				{ field: `group_${col.group_no}_dc_ratio`, headerName: "할인율", type: 'numberType', cellStyle: styleOfDCRatio, width: 60 },
			],
		})
	})
