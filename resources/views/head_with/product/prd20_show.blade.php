...
<div class="show_layout py-3 px-sm-3">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#신규상품">신규상품</a>
        </li>
        <li class="nav-item">
    ...
    <form name="detail">
        <div class="card_wrap aco_card_wrap">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="신규상품">
                    <div class="card shadow">
                        <div class="card-header mb-0">
                            <a href="#">신규상품 연동설정</a>
                        </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline form-radio-box">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_d_cat_type_new" id="ex_d_cat_type_new_0" class="custom-control-input" value="0" @if(@$shop_ad_goods_new->ex_d_cat_type == '0') checked @endif />
                                                                    <label class="custom-control-label" for="ex_d_cat_type_new_0">전체 카테고리 노출</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_d_cat_type_new" id="ex_d_cat_type_new_1" class="custom-control-input" value="1" @if(@$shop_ad_goods_new->ex_d_cat_type == '1') checked @endif />
                                                                    <label class="custom-control-label" for="ex_d_cat_type_new_1">일부 카테고리 제외</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline form-radio-box">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_com_type_new" id="ex_com_type_new_0" class="custom-control-input" value="0" @if(@$shop_ad_goods_new->ex_com_type == '0') checked @endif />
                                                                    <label class="custom-control-label" for="ex_com_type_new_0">전체 업체 노출</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_com_type_new" id="ex_com_type_new_1" class="custom-control-input" value="1" @if(@$shop_ad_goods_new->ex_com_type == '1') checked @endif />
                                                                    <label class="custom-control-label" for="ex_com_type_new_1">일부 업체 제외</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline form-radio-box">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_brand_type_new" id="ex_brand_type_new_0" class="custom-control-input" value="0" @if(@$shop_ad_goods_new->ex_brand_type == '0') checked @endif />
                                                                    <label class="custom-control-label" for="ex_brand_type_new_0">전체 브랜드 노출</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_brand_type_new" id="ex_brand_type_new_1" class="custom-control-input" value="1" @if(@$shop_ad_goods_new->ex_brand_type == '1') checked @endif />
                                                                    <label class="custom-control-label" for="ex_brand_type_new_1">일부 브랜드 제외</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline form-radio-box">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_goods_type_new" id="ex_goods_type_new_0" class="custom-control-input" value="0" @if(@$shop_ad_goods_new->ex_goods_type == '0') checked @endif />
                                                                    <label class="custom-control-label" for="ex_goods_type_new_0">전체 상품 노출</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" name="ex_goods_type_new" id="ex_goods_type_new_1" class="custom-control-input" value="1" @if(@$shop_ad_goods_new->ex_goods_type == '1') checked @endif />
                                                                    <label class="custom-control-label" for="ex_goods_type_new_1">일부 상품 제외</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="flax_box">
                                                                <select name="new_goods_date_new" id="new_goods_date_new" class="form-control form-control-sm ">
                                                                    <option value="">전체</option>
                                                                    <option value="7D" ;="">최근 1주</option>
                                                                    <option value="14D" ;="">최근 2주</option>
                                                                    <option value="1M" ;="">최근 30일</option>
                                                                    <option value="2M" ;="">최근 60일</option>
                                                                    <option value="3M" ;="">최근 90일</option>
                                                                </select>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline">
                                                                <div class="form-inline-inner input_box">
                                                                    <div class="form-group">
                                                                        <input type='text' class="form-control form-control-sm" name='price_from_new' value="{{ number_format(@$shop_ad_goods_new->price_from) }}" />
                                                                        원 이상
                                                                    </div>
                                                                </div>
                                                                <span class="text_line">~</span>
                                                                <div class="form-inline-inner input_box">
                                                                    <div class="form-group">
                                                                        <input type='text' class="form-control form-control-sm" name='price_to_new' value="{{ number_format(@$shop_ad_goods_new->price_to) }}" />
                                                                        원 이하인 경우만 노출
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-inline">
                                                                <div class="form-inline-inner input_box">
                                                                    <div class="form-group">
                                                                        <input type='text' class="form-control form-control-sm" name='qty_limit_new' value="{{ number_format(@$shop_ad_goods_new->qty_limit) }}" />
                                                                        개 이상일 경우만 노출
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="flex_box">
                                                                ...
                                                                <select name="ad_set" id="ad_set" class="form-control form-control-sm">
                                                                    <?php
                                                                        collect($ads_list)->map(function ($item) use ($selected_ad) {
                                                                            $key = $item->value;
                                                                            $value = $item->name;
                                                                            $selected = ($key == $selected_ad->value) ? 'selected' : "";
                                                    ...
                                                    <tr>
                                                        <td class="bd" rowspan="1" colspan="3">
                                                            ...
                                                            <br>
                                                            신규 상품
                                                            <a onclick="previewList('new')" href="#">[미리보기]</a>
                                                            <br>
                                                            {{ $goods_new_url }}
                                                            <br>
                                                        </td>
