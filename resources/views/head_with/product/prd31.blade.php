...
<script language="javascript">
	...
	var columns = [
        ...
        {headerName:"일련번호", field: "ord_opt_no", width: 72, pinned:'left', type:'HeadOrderNoType'},
        ...
        {headerName:"상태", field: "baesong_status", width: 72, pinned:'left'},
        {headerName:"판매처 상품번호", field: "order_product_id", width: 115},
        {headerName:"사방넷 상품번호", field: "sabangnet_product_id", width: 115},
        {headerName:"고객사 상품번호", field: "partner_product_id", width: 115},
        {headerName:"상품번호", field: "goods_no", width: 72, editable: true, cellStyle: editCellStyle },
        ...
        {headerName:"수량", field: "quantity", width: 55, type: 'currencyType'},
        ...
        {headerName:"주문상태", field: "ord_state", width: 85, cellStyle:StyleOrdState},
        {headerName:"클레임상태", field: "clm_state", width: 85, cellStyle:StyleClmState},
        {headerName:"주문일시", field: "orderdate", width: 125},
        {headerName:"주문접수일시", field: "order_reg_date", width: 125},
        {headerName:"등록자", field: "admin_nm", width: 90},
        {headerName:"등록일시", field: "rt", width: 125},
        {headerName:"최종수정일시", field: "ut", width: 125},
    ];
