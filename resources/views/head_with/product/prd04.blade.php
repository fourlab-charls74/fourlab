...
<<<<<<< HEAD
    ...
    const columns = [   
        ...
        { field: "sale_type", headerName: "세일구분" },
        { field: "sale_yn", headerName: "세일여부", cellStyle: YELLOW_CELL },
        { field: "before_sale_price", headerName: "이전세일가", type: 'currencyType' },
        { field: "sale_price", headerName: "세일가", cellStyle: YELLOW_CELL, type: 'currencyType' },
        { field: "sale_rate", headerName: "세일율(%)", cellStyle: YELLOW_CELL, cellRenderer: (params) => Math.round(params.data.sale_rate) },
...
=======
	...
	const columns = [   
		...
		{ field: "img", headerName: "이미지", width:60, type:'GoodsImageType', hide: true, cellStyle:{"text-align":"center"} },
		{ field: "img_url", headerName: "이미지_url", width:30, hide: true },
		{ field: "goods_nm", headerName: "상품명", width: 230, type:"HeadGoodsNameType" },
		...
		{ field: "sale_dt_yn", headerName: "타임세일여부", width:96, cellStyle: YELLOW_CELL },
