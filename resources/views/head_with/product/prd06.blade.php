        ...
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                ...
                <div>
					...
					<a href="#" onclick="initSearch()" class="btn btn-sm btn-outline-primary mr-1">검색조건 초기화</a>
            ...
            <div class="card-body">
				...
				<div class="row">
                    <div class="col-lg-4 inner-td">
                        <div class="form-group">
                            <label for="name">세일여부/구분/타임세일</label>
                            <div class="flex_box">
                                <select id="sale_yn" name="sale_yn" class="form-control form-control-sm mr-3" style="width:70px;">
                                    <option value="">전체</option>
...
<script language="javascript">
    ...
    const columns = [
        ...
        { field: "goods_no", headerName: "온라인코드", width: 70, pinned: 'left', cellStyle: {'text-align':'center'}},
        ...
        { field: "sale_stat_cl_val", headerName: "상품상태", width:58, cellStyle: (params) => cellStyleGoodsState(params) },
        { field: "goods_opt", headerName: "옵션", width:108, cellStyle: (params) => colorGrouping(params) },
        { field: "good_qty", headerName: "온라인재고", width:70, cellStyle: {textAlign: 'right'}, cellStyle: (params) => colorGrouping(params) },
        { field: "wqty", headerName: "창고재고", width:58, cellStyle: {textAlign: 'right'}, cellStyle: (params) => colorGrouping(params) },
        ...
        { field: "sale_dt_yn", headerName: "타임세일여부", width:96, cellStyle: CELL_COLOR.YELLOW },
        ...
        { field: "qty", headerName: "재고수", width:46 },
