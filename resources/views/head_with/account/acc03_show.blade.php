...
<script type="text/javascript" charset="utf-8">
    ...
    const URL = {
        UPDATE: '/head/account/acc03/show_update',
        REMOVE: '/head/account/acc03/show_delete',
        CLOSE: '/head/account/acc03/show_close'
    }
    ...
    function Search() {
        ...
        gx.Request(`/head/account/acc03/show_search`, data, -1, () => {
            // callback
        });
    };
