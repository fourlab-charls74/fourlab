										...
										<tbody>
											<tr>
												...
												<td>
													...
													<span>※ XMD >> 코드관리 >> 시스템 부속코드등록에서 엑셀 다운로드</span>
												</td>
											</tr>
										</tbody>
									</table>
...
<script language="javascript">
	var columnDefs = [
		...
		{headerName:"코드길이",		field:"code_len",		width:90},
		{headerName:"세부코드",		field:"detail_code",	width:90},
		{headerName:"세부코드명",	field:"detail_code_nm",	width:100},
		{headerName:"사용여부",		field:"use_yn",			width:90},
		{headerName:"구분",			field:"code_kind",		width:100},
	];
...
<script type="text/javascript" charset="utf-8">
	...
	function Upload(){
		...
		$.ajax({
			url: '/head/xmd/code/code01/upload', // point to server-side PHP script
