...
@section('content')
	...
	<script language="javascript">
		let columns = [
			...
			{field:"ord_type_nm" , headerName:"주문구분", width:72, pinned:'left'},
			{field:"ord_kind_nm" , headerName:"출고구분", width:72, cellStyle:StyleOrdKind, pinned:'left'  },
			{field:"user_nm" , headerName:"주문자",pinned:'left'  },
			{field:"r_nm" , headerName:"수령자", width:60, pinned:'left'  },
			...
			{field:"pay_stat_nm" , headerName:"입금상태", width:72  },
