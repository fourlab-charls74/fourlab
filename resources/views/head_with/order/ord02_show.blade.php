...
@section('content')
				...
				<div class="card shadow">
					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<div id="div-gd" style="margin-bottom: 7px;" class="ag-theme-balham"></div>
						</div>
	...
	<script type="text/javascript">
		...
		const columns = [
			...
			{field:"ord_opt_no" , headerName:"주문일련번호", width: 80, sortable:"ture", cellStyle: { 'text-align': 'center' }, hide: true,
				type: function(params) {
					if(params.data.goods_no) return 'HeadOrdOptNoType';
					return "none";
				}
			},
			{field: "goods_nm" ,headerName: "상품명", minWidth: 150, width: 0, wrapText: true, autoHeight: true,
				cellRenderer: (params) => {
					if (params.value !== undefined) {
						if (params.data.goods_no) return '<a href="javascript:openHeadProduct(\'' + params.data.goods_no + '\');">' + params.value + '</a>';
						else return params.value;
					}
				}
			},
			{field: "style_no" ,headerName: "스타일넘버", width: 150},
