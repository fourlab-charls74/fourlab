...
<script>
    ...
    const columns = [
        ...
        {field:"ord_opt_no" , headerName:"주문일련번호", width:100,sortable:"ture", pinned: 'left', type:'HeadOrderNoType'},
        {field:"ord_state_nm" , headerName:"주문상태", width:90,cellStyle:StyleOrdState, pinned: 'left'  },
        {field:"clm_state" , headerName:"클레임상태", width:100,cellStyle:StyleClmState, pinned: 'left'  },
        {field:"pay_stat" , headerName:"입금상태", width:90  },
        {field:"goods_type_nm" , headerName:"상품구분", width:90, cellStyle:StyleGoodsType  },
        ...
        {field:"goods_addopt" , headerName:"추가옵션", width:80  },
        {field:"qty" , headerName:"주문수량", width:90},
        {field:"user_nm" , headerName:"주문자(아이디)", width:100  },
        {field:"r_nm" , headerName:"수령자", width:90  },
        {field:"price" , headerName:"판매가", width:90, type: 'currencyType'  },
        {field:"sale_amt" , headerName:"쿠폰/할인", width:90, type: 'currencyType'  },
        {field:"gift" , headerName:"사은품", width:80  },
        {field:"dlv_amt" , headerName:"배송비", width:80 , type: 'currencyType'  },
        {field:"pay_fee" , headerName:"결제수수료", width:90, type: 'currencyType'  },
        {field:"pay_type" , headerName:"결제방법", width:90   },
        {field:"fintech" , headerName:"간편결제", width:80   },
        {field:"cash_apply_yn" , headerName:"현금영수증신청", width:80   },
        {field:"cash_yn" , headerName:"현금영수증발행", width:80   },
        {
            field:"ord_type",
            headerName:"주문구분",
            width:90,
        ...
        {field:"baesong_kind" , headerName:"배송구분", width:90  },
        {field:"dlv_type" , headerName:"배송방식", width:90  },
        {field:"dlv_nm" , headerName:"택배업체", width:90  },
        {field:"dlv_no" , headerName:"송장번호", width:90  },
        ...
        {field:"mobile_yn" , headerName:"모바일여부"  },
