...
<body class="{{@$className}}">
    ...
    <div class="login_inner">
        <div class="cont">
            <div class="right_cont" style="background-image:url('/theme/{{config('shop.theme')}}/images/login_fourlab3_bg.jpg');background-size:contain;">
                <dl>
                    <dt>
            ...
            <div class="left_cont">
                <form method="POST" action="{{ route('head.login') }}" class="login_input_box">
                    ...
                    <div class="login_mobile_tit">
                        <img src="/theme/{{config('shop.theme')}}/images/fourlab_logo_b.png" style="width:80%">
                    </div>
