...
.ag-row-level-1 {
	...
	<script language="javascript">
		...
		async function Search() {
			...
			gx.Request('/shop/product/prd02/search', data, 1, function(d) {
		...
		function AddProduct_upload() {
			var url = '/shop/product/prd02/product_upload';
		...
		function AddProduct() {
			var url = '/shop/product/prd02/create';
			var product = window.open(url, "_blank", "toolbar=no,scrollbars=yes,resizable=yes,status=yes,top=100,left=100,width=1024,height=900");
		}

		function EditProduct(product_code, goods_no) {
			var url = '/shop/product/prd02/edit-goods-no/' + product_code + '/' + goods_no;
		...
		function AddProducts() {
			var url = '/shop/product/prd02/batch-create';
			var product = window.open(url, "_blank", "toolbar=no,scrollbars=yes,resizable=yes,status=yes,top=100,left=100,width=1024,height=900");
		}
