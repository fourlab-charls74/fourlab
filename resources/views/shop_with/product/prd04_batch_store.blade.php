...
<script type="text/javascript" charset="utf-8">
	...
	function Save() 
	{
		...
		$.ajax({
			async: true,
			type: 'put',
			url: '/shop/product/prd04/batch_store',
			data: {
	...
	function Upload(){
		...
		$.ajax({
			url: '/shop/product/prd04/upload_store', // point to server-side PHP script
