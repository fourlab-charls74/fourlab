	...
	<div id="search-area" class="search_cum_form">
		<div class="card mb-3">
			...
			<div class="d-flex card-header justify-content-between">
				<h4>검색</h4>
				<div class="flax_box">
					<a href="javascript:;" id="search_sbtn" onclick="Search();" class="btn btn-sm btn-primary shadow-sm mr-1"><i class="fas fa-search fa-sm text-white-50"></i> 조회</a>
                    ...
                    <a href="javascript:;" onclick="return window.open('/shop/pos', '_blank', 'toolbar=no,scrollbars=yes,resizable=yes,status=yes,top=0,left=0,width=1920,height=980');" class="btn btn-sm btn-primary shadow-sm pl-2 mr-1"><i class="bx bx-plus fs-16"></i>수기 등록</a>
                    ...
                    <div class="col-lg-4 inner-td">
                        <div class="form-group">
                            ...
                            <div class="date-switch-wrap form-inline">
                                ...
                                <div class="custom-control custom-switch date-switch-pos"  data-toggle="tooltip" data-placement="top" data-original-title="판매일자 사용">
...
<script type="text/javascript" charset="utf-8">
    ...
    let columns = [
        ...
        {field: "pay_stat", headerName: "입금상태", pinned: 'left', width: 60, cellStyle: {'text-align': 'center'}, hide:true},
        {field: "goods_no", headerName: "온라인코드", width: 70, cellStyle: {'text-align': 'center'}, hide:true},
        {field: "opt_val", headerName: "옵션", width: 130, hide:true},
        {field: "r_nm", headerName: "수령자", width: 70, hide:true},
        {field: "goods_price", headerName: "자사몰판매가", width: 85, type: "currencyType", hide:true},
		{field: "acc_amt", headerName: "정산금액", width: 80, type: "currencyType", hide:true},
        {field: "pr_code_nm", headerName: "판매처수수료", width: 80, hide:true},
        {field: "dlv_amt", headerName: "배송비", width: 60, type: "currencyType", hide:true},
        {field: "sales_com_fee", headerName: "판매수수료", width: 80, type: "currencyType", hide:true},
        {field: "ord_kind", headerName: "출고구분", width: 60, cellStyle: StyleOrdKind, hide:true},
        {field: "baesong_kind", headerName: "배송구분", width: 60, hide:true},
        {field: "state", headerName: "처리현황", width: 80, hide:true},
   ];
	...
	function Search() {
		...
		gx.Request('/shop/order/ord01/search', data, 1, function(e) {
    ...
    // 수기등록 팝업오픈
    function Add() {
        let url = '/shop/order/ord01/create';
        window.open(url, "_blank", "toolbar=no,scrollbars=yes,resizable=yes,status=yes,top=500,left=500,width=1200,height=800");
    }
    
    // 수기일괄등록 팝업오픈
    function AddBatch() {
        let url = '/shop/order/ord01/batch-create';
