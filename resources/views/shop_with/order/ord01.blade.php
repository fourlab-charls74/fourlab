		...
		<div class="card mb-3">
			...
			<div class="d-flex card-header justify-content-between">
				...
				<div class="flax_box">
                    ...
                    <a href="javascript:void(0);" onclick="return window.open('/shop/pos', '_blank', 'toolbar=no,scrollbars=yes,resizable=yes,status=yes,top=0,left=0,width=1920,height=980');" class="btn btn-sm btn-primary shadow-sm pl-2 mr-1"><i class="bx bx-plus fs-16"></i>수기 등록</a>
