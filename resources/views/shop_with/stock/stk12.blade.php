...
@section('content')
    ...
    <script language="javascript">
        let columns = [
            ...
            {field: "prd_cd_p", headerName: "코드일련", pinned: 'left', width: 100, cellStyle: {"text-align": "center"}},
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function Search() {
            ...
            gx.Request('/shop/stock/stk12/search', data, 1, function(d) {
        ...
        function requestRelease() {
            ...
            axios({
                url: '/shop/stock/stk12/request-release',
                method: 'post',
                data: data,
            }).then(function (res) {
        ...
        const openBatchPopup = () => {
            const url = '/shop/stock/stk12/batch';
