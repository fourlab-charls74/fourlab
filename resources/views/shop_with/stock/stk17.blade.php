...
@section('content')
            ...
            <div class="card mb-3">
                <div class="d-flex card-header justify-content-between">
                    ...
                    <div class="flax_box">
                        ...
                        <a href="/shop/stock/stk16" class="btn btn-sm btn-outline-primary shadow-sm pl-2 mr-1"><i class="fas fa-step-backward fa-sm"></i> 출고리스트</a>
            ...
            <div class="card-title">
                <div class="filter_wrap d-flex justify-content-between">
                    ...
                    <div class="d-flex flex-grow-1 flex-column flex-lg-row justify-content-end align-items-end align-items-lg-center">
                        ...
                        <div class="d-flex">
                            <a href="javascript:requestRelease();" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-check fa-sm text-white-50 mr-2"></i>출고요청</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" charset="utf-8">
        let columns = [
            ...
            {field: "req_comment", headerName: "요청메모", width: 300, editable: true, cellClass: 'hd-grid-edit'},
			{width: 0}
        ];
