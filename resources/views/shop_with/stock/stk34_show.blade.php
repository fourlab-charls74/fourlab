...
@section('title','동종업계 월별매출관리 등록')
@section('content')

<div class="py-3 px-sm-3">
    <div class="page_tit">
        <h3 class="d-inline-flex">동종업계 월별매출관리 등록</h3>
        <div class="d-inline-flex location">
            <span class="home"></span>
            <span>/ 매장관리</span>
            <span>/ 동종업계 월별매출관리</span>
            <span>/ 동종업계 월별매출관리 등록</span>
        </div>
    </div>
    ...
    let columns = [
        ...
        function Search() {
            ...
            if(store_no == '') {
                ...
                gx.Request('/shop/stock/stk34/com_search', data, -1, function(e) {
                    formatDate(e);
                });
            }
        }
