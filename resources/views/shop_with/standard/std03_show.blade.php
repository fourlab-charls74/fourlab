...
<script type="text/javascript" charset="utf-8">
    ...
    async function addStorage() {
        ...
        axios({
            ...
            if(res.data.code === 200) {
                alert(res.data.msg);
                opener.Search();
                location.href = "/shop/standard/std03/show/" + res.data.data.storage_cd;;
            } else {
    ...
    async function updateStorage() {
        ...
        axios({
            url: `/shop/standard/std03/update`,
            method: 'put',
            data: getFormInputData(),
        }).then(function (res) {
            if(res.data.code === 200) {
    ...
    async function deleteStorage() {
        ...
        axios({
            url: `/shop/standard/std03/delete/` + f1.storage_cd.value,
            method: 'delete',
        }).then(function (res) {
            if(res.data.code === 200) {
                alert(res.data.msg);
    ...
    async function duplicateCheckStorageCode() {
        ...
        const response = await axios({ 
            url: `/shop/standard/std03/dupcheck/${storage_cd}`, 
            method: 'get' 
        });
