...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request("/shop/standard/std05/search-store/" + sale_type_cd, "store_type_cd=" + store_type_cd, -1, function(d) {
    ...
    function Cmder(type) {
        ...
        let url = '/shop/standard/std05/' + type;
        ...
        axios({
            ...
            if(res.data.code === 200) {
                ...
                opener.Search();
                if(type === 'add') {
                    location.href = "/shop/standard/std05/show/" + res.data.data.sale_type_cd;
                } else {
                    Search();
                }
            } else {
