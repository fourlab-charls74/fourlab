...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request("/shop/standard/std07/search-store-fee-history", params, -1, function(e) {
            resetAddBtn();
        });
    }
    ...
    function Save() {
        ...
        axios({
            url: '/shop/standard/std07/update-store-fee',
            method: 'put',
            data: rows,
        }).then(function (res) {
    ...
    function removeData() {
        ...
        axios({
            url: '/shop/standard/std07/remove-store-fee/' + remove_idx,
            method: 'delete',
        }).then(function (res) {
            if(res.data.code === 200) {
                alert(res.data.msg);
