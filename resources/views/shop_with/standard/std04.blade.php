...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request("/shop/standard/std04/search", data, -1, function(d) {
    ...
    function SearchDetail(store_cd, store_nm) {
        ...
        gx2.Request("/shop/standard/std04/search-competitor/" + store_cd, "", -1, function(d) {
    ...
    function updateCompetitors() {
        ...
        axios({
            url: `/shop/standard/std04/update-competitor`,
            method: 'put',
            data: {
