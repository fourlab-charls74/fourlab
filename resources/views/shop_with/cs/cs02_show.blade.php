...
<script type="text/javascript" charset="utf-8">
    ...
    function GetProducts() {
        ...
        gx.Request('/shop/cs/cs02/search-return-products', data, -1, function(e) {
            updatePinnedRow();
        });
    }
    ...
    function Save(cmd) {
        ...
        if(cmd === 'add') {
            ...
            axios({
                url: '/shop/cs/cs02/add-storage-return',
                method: 'put',
                data: {
                    sgr_date,
                    storage_cd,
            ...
            axios({
                url: '/shop/cs/cs02/update-storage-return',
                method: 'put',
                data: {
                    sgr_cd,
                    comment,
    ...
    // 상품 추가
    function addGoods() {
        const url = `/shop/api/goods/show?storage_cd=` + document.f1.storage_cd.value;
