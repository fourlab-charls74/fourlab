...
<script type="text/javascript" charset="utf-8">
	...
	function Search() {
		...
		gx.Request('/shop/cs/cs02/search', data, 1);
	}

    // 상품반품이동 상품관리 팝업 오픈
    const openDetailPopup = (sgr_cd = '') => {
        const url = '/shop/cs/cs02/show/' + sgr_cd;
    ...
    function ChangeState() {
        ...
        axios({
            url: '/shop/cs/cs02/update-return-state',
            method: 'put',
            data: {data: rows},
        }).then(function (res) {
