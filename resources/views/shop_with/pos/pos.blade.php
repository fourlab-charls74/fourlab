...
<link href="{{ URL::asset('css/pos.css')}}?v=20240703" rel="stylesheet" type="text/css" />
...
<div id="pos" class="d-flex flex-column w-100 m-0" style="min-height: 100vh;max-width: 100vw;">
    ...
    <div id="pos_header" class="d-flex justify-content-between align-items-center bg-white pl-3" style="border-bottom: 1px solid #999;">
        ...
        <div class="d-flex align-items-center">
            ...
            <p id="clock" class="fw-sb mr-4" style="width: 250px;"></p>
    ...
    {{-- 주문등록화면 --}}
    <div id="pos_order" class="pos2 flex-1 d-flex">
	    ...
	    <div class="d-flex flex-column p-3 flex-1">
			    ...
			    <div class="d-flex pt-3">
				    <div class="flex-1 pr-3">
					    <div class="flex-1 pr-2 mb-2">
						    <div class="d-flex justify-content-between align-items-center fs-10 fw-b mb-1">
							    <p>총 판매금액</p>
							    <p><strong id="total_goods_sh_amt" class="fs-14 fw-b mr-1">0</strong>원</p>
						    </div>
						    <div class="d-flex justify-content-between align-items-center fs-10 fw-sb mb-1">
							    <p>총 할인금액</p>
					    ...
					    <div class="flex-1 d-flex pr-2">
						    <button type="button" class="butt flex-1 fc-white fs-12 fw-sb br-1 bg-red p-3" onclick="return cancelOrder();">주문 초기화</button>
					    </div>
				    </div>
				    <div class="flex-2 d-flex">
					    <div class="flex-1 d-flex">
						    <div class="flex-2 d-flex flex-column mr-3">
							    <button type="button" class="butt d-flex justify-content-between flex-1 fc-white fs-16 fw-b br-2 bg-skyblue px-4 py-3 mb-3" data-toggle="modal" data-target="#payModal" data-title="신용카드 결제" data-pay-type="card_amt">
								    <span class="fs-12 fw-sb mt-1">신용카드</span>
								    <span id="card_amt">0</span>
								    <input type="hidden" name="card_amt" value="0">
							    </button>
							    <button type="button" class="butt d-flex justify-content-between flex-1 fc-white fs-16 fw-b br-2 bg-blue px-4 py-3 mb-3" data-toggle="modal" data-target="#payModal" data-title="현금 결제" data-pay-type="cash_amt">
								    <span class="fs-12 fw-sb mt-1">현금</span>
								    <span id="cash_amt">0</span>
								    <input type="hidden" name="cash_amt" value="0">
							    </button>
							    @if(@$store->point_out_yn == 'Y')
								    <!--적립금 사용 가능 매장 //-->
								    <button type="button" class="butt d-flex justify-content-between flex-1 fc-white fs-16 fw-b br-2 bg-gray px-4 py-3" data-toggle="modal" data-target="#payModal" data-title="적립금 사용" data-pay-type="point_amt">
									    <span class="fs-12 fw-sb mt-1">적립금</span>
									    <span id="point_amt">0</span>
									    <input type="hidden" name="point_amt" value="0">
								    </button>
							    @else
								    <!--적립금 사용 불가 매장 //-->
								    <button type="button" class="butt d-flex justify-content-between flex-1 fc-white fs-16 fw-b br-2 bg-gray px-4 py-3" onClick="alert('적립금을 사용할 수 없는 매장입니다.\r\n관리자에게 문의해 주십시요.');">
									    <span class="fs-12 fw-sb mt-1">적립금</span>
									    <span id="point_amt">0</span>
									    <input type="hidden" name="point_amt" value="0">
								    </button>
						    ...
						    <button type="button" class="butt flex-1 fc-white fs-20 fw-b br-2 bg-mint p-2" onclick="return sale();">판 매</button>
					    </div>
				    </div>
			    </div>
		    </div>
	    ...
	    <div class="d-flex flex-column pr-3 pb-3" style="width:500px;min-width: 500px;">
		    <div class="d-flex align-items-center fs-12 fw-sb mt-4 mb-3">
			    <p class="mr-3">주문번호</p>
			    <div class="d-flex">
		    ...
		    <div class="d-flex mb-3">
			    <div class="d-flex b-2-gray mr-3" style="width:150px;height:150px;">
				    <img src="" alt="" id="cur_img" class="w-100">
			    </div>
			    <div>
				    <ul class="fs-09 fw-sb">
					    <li class="d-flex mb-2">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">상품명</p>
						    <p id="cur_goods_nm" class="fw-b" style="height: 37px;"></p>
					    </li>
					    <li class="d-flex mb-1">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">상품코드</p>
						    <p id="cur_prd_cd"></p>
					    </li>
					    <li class="d-flex mb-1">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">컬러</p>
						    <p id="cur_goods_color"></p>
					    </li>
					    <li class="d-flex mb-1">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">사이즈</p>
						    <p id="cur_goods_size"></p>
					    </li>
					    <li class="d-flex mb-1">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">정상가</p>
						    <p id="cur_goods_sh"></p>
					    </li>
					    <li class="d-flex mb-1">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">현재가</p>
						    <p id="cur_ori_price"></p>
					    </li>
					    <li class="d-flex">
						    <p class="fc-blue fw-sb" style="min-width: 80px;">할인율</p>
						    <p id="cur_dc_rate"></p>
					    </li>
				    </ul>
			    </div>
					    ...
					    <tr>
						    ...
						    <td class="px-1">
							    <div class="d-flex w-100">
								    <input id="cp_serial_num" class="inp fs-10 fw-sb b-1-gray px-2 mr-1 w-75" style="height: 30px;">
								    <button type="button" class="butt fc-white fs-08 br-05 bg-navy px-1 py-1 w-25" onclick="return addCoupon();">등록</button>
							    </div>
						    </td>
					    </tr>
				    </table>
		    ...
		    <div class="py-0 mb-3">
			    <div class="user_box d-flex position-relative fw-sb b-2-gray p-4">
...
<script type="text/javascript" charset="utf-8">
    ...
    const columns = [
        ...
        {field: "sale_type", headerName: "판매유형", width: 100, cellStyle: LineHeight40Right,
            cellRenderer: (params) => {
				return sale_types.find(s => s.sale_kind == params.value)?.sale_type_nm || '-';
            }
        },
