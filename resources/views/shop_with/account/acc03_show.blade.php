...
<script type="text/javascript" charset="utf-8">
    ...
    const URL = {
        UPDATE: '/shop/account/acc03/show_update',
        REMOVE: '/shop/account/acc03/show_delete',
        CLOSE: '/shop/account/acc03/show_close'
    }
    ...
    function Search() {
        ...
        gx.Request(`/shop/account/acc03/show_search`, data, -1, () => {
            // callback
        });
    };
