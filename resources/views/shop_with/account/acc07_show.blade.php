                ...
                <div class="card-body">
                    ...
                    <div class="row p-0 m-0 w-100">
                        ...
                        <div class="col-lg-4 mt-3">
                            ...
                            <p class="fs-14 font-weight-bold"><i class="bx bx-won fs-16 text-primary"></i> 기타재반자료 - <span id="extra_amt">{{ number_format(@$closed->extra_amt) }}</span>원</p>
                            <div class="p-3 mt-2 custom-box">
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-between">
                                        <p>인건비</p>
...
<script type="text/javascript" charset="utf-8">
    ...
    const columns = [
		...
		{field: "ord_opt_no", headerName: "일련번호", width: 60, cellStyle: CENTER, pinned: 'left'},
    ...
    function Search(callback) {
        ...
        gx.Request('/shop/account/acc07/show-search/except-online', data, -1);
    };

    function SearchOnline() {
        let data = $('form[name="search"]').serialize();
        gx2.Aggregation({ "sum": "top" });
        gx2.Request('/shop/account/acc07/show-search/online', data, -1);
    };
