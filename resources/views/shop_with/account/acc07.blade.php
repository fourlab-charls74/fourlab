...
<script type="text/javascript" charset="utf-8">
	...
	function Search() {
        ...
        gx.Request('/shop/account/acc07/search', data, -1);
    }

	const openDetailPopup = (idx) => {
		const url = '/shop/account/acc07/show/' + idx;
	...
	// 	const url = '/shop/account/acc05/show?date=' + sdate.replaceAll('-', '') + '&store_cd=' + store_cd;
