    ...
    let store_list_columns = [
		...
		{field: "store_nm", headerName: "매장명", width: 200,
            cellRenderer: function(params) {
                return `<a href="/shop/stock/stk25?store_cd=${params.data.store_cd}&sale_month=${$("[name=sdate]").val()}">${params.value}</a>`;
            }
        },
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
		...
		gx2.Request("/shop/sale/sal18/search-store", data, -1, function(d) {
            SearchDetail();
        });
    }
	...
	function SearchDetail() {
        ...
        gx.Request("/shop/sale/sal18/search", data, -1, function(d) {
    ...
    function moveToStk25() {
        location.href = '/shop/stock/stk25?sale_month=' + $("[name=sdate]").val();
    }
</script>
@stop
