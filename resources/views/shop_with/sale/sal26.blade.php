...
@section('content')
    ...
    <script type="text/javascript" charset="utf-8">
        let columns = [
            {headerName: "매장명", field: "store_nm", pinned:'left', aggSum:"합계", aggAvg:"평균",width:170,
                cellRenderer: function(params) {
                    ...
                    return '<a href="/shop/sale/sal24?store_cd='+ params.data.store_cd + '&sdate='+ s_date + '&edate='+ e_date + '&ord_type=' + s_ord_type + '&ord_state='+ s_ord_state + '&item='+ s_item + '&brand='+ s_brand + '&goods_nm='+ s_goods_nm + '&sell_type=' + sell_type + '&pr_code=' + pr_code + '" target="new">'+ params.value+'</a>';
                }
        ...
        function Search() {
            ...
            gx.Request('/shop/sale/sal26/search', data, -1, function(data){
