...
<div id="filter-area" class="card shadow-none mb-4 ty2 last-card">
            ...
            {headerName: "입금일", field: "date",width:120,cellClass:'hd-grid-code',pinned:'left',aggSum:"합계",aggAvg:"평균",
                cellRenderer: function (params) {
                    ...
                    if (params.value !== undefined) {
                        return "<a href='#' onclick='openDayStatistics(" + JSON.stringify(params.value) + ")'>" + params.value + "</a>";
                    }
                }
            },
            {headerName: '매출액구분',
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function Search() {
            ...
            gx.Request('/partner/sales/sal03/search', data);
        }

        const openDayStatistics = (date) => {
