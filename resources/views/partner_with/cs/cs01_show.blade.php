                        ...
                        <div class="search-area-ext d-none  row">
                            <div class="col-lg-4 inner-td">
                                <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <div class="form-inline-inner input_box">
                                            <select name="clm_state" id="ce" class="form-control form-control-sm search-enter search-all">
                                                <option value="">전체</option>
                                        ...
                                        <span class="text_line">/</span>
                                        <div class="form-inline-inner input_box">
                                            <select name="clm_type" id="ce" class="form-control form-control-sm search-enter search-all">
                                                <option value="">전체</option>
                            ...
                            <div class="col-lg-4 inner-td">
                                <div class="form-group">
                                    ...
                                    <div class="flax_box">
                                        <select name="clm_reason" id="ce" class="form-control form-control-sm search-enter search-all">
                                            <option value="">전체</option>
                            ...
                            <div class="col-lg-4 inner-td">
                                <div class="form-group">
                                    ...
                                    <div class="flax_box">
                                        <select name="refund_yn" id="ce" class="form-control form-control-sm search-enter search-all">
                                            <option value="">전체</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 inner-td">
                                <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <div class="form-inline-inner input_box">
                                            <select name="limit" id="ce" class="form-control form-control-sm search-enter search-all">
                                        ...
                                        <span class="text_line">/</span>
                                        <div class="form-inline-inner input_box">
                                            <input type='text' class="form-control form-control-sm search-enter search-all" name='head_desc' value=''>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- DataTales Example -->
    <div id="filter-area" class="card shadow-none my-3 ty2 last-card">
