...
@section('title','월별 클레임 통계')
@section('content')
    <div class="page_tit">
        <h3 class="d-inline-flex">월별 클레임 통계</h3>
...
<script language="javascript">
    ...
    var columns = [
        {headerName: "등록일", field: "d", cellStyle: {'text-align':'center'} ,aggAvg:"평균", aggSum:"합계",
            cellRenderer: function (params) {
                if (params.node.rowPinned === 'top') {
                    return params.value;
                }
                if (params.value !== undefined) {
                    return "<a href='#' onclick='openDayClaimStatistics(" + JSON.stringify(params.data) + ")'>" + params.value + "</a>";
                }
            }
        },
...
<script type="text/javascript" charset="utf-8">
    ...
    const openDayClaimStatistics = (obj) => {
        let date = obj.d;
        date = String(date) + "00";
