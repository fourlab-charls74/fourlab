...
@section('content')
        ...
        <div id="search-area" class="search_cum_form">
            <div class="card mb-3">
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-4 inner-td">
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    ...
                                    <input type="text" name="brand_cd" class="form-control form-control-sm" style="width:calc(50% - 10px);margin-left:10px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-gutters align-items-center mt-2" id="goods_colors_area" style="display:none;">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">입력 가능한 색상</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800 text-xs">
                                    <p>
                                    ...
                                    <b>* 색상을 여러개 입력할 경우 위의 예처럼 콤마(,)를 사용하여 색상을 등록합니다. </b>
                                </div>
                        </div>
                    </div>

                    <div class="row no-gutters align-items-center mt-2" id="code_class_area" style="display:none;">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">미등록 항목</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800 text-xs" id="code_class"></div>
                        </div>
                    </div>
                    <div class="row no-gutters align-items-center mt-2" id="excel_area" style="display:none;">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">엑셀 업로드</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800 text-xs">
                                    <input type="file" name="file" id="file" onchange="ImportFile();">
                                    <input type="button" name="grid_reset" id="grid_reset" onclick="Cmder('reset');" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="그리드초기화">
                                </div>
                        </div>
                    </div>
    ...
    <script language="javascript">
        ...
        var columns = [
                ...
                {field:"goods_type",headerName:"상품구분",width:80,cellStyle:StyleGoodsTypeNM,pinned:'left',editable: true,},
                {field:"com_nm",headerName:"업체",pinned:'left',editable: true, },
                {field:"opt_kind_nm",headerName:"품목",pinned:'left', editable: true, },
                {field:"brand_nm",headerName:"브랜드", editable: true,},
                {field:"style_no",headerName:"스타일넘버", editable: true,},
                ...
                {field:"goods_nm" , headerName:"상품명",type:"GoodsNameType",editable: true,},
                {field:"sale_stat_cl",headerName:"상품상태",width:100,cellStyle:StyleGoodsState},
                {field:"goods_no",headerName:"상품번호", width:80,editable: true,
                    cellRenderer: function(params) {
                        if (params.value !== undefined) {
                ...
                {field:"class",headerName:"분류",editable: true, },

                {field:"item_001",headerName:"제품소재", editable: true, },
                {field:"item_002",headerName:"색상",editable: true,},
                {field:"item_003",headerName:"치수",editable: true,},
                {field:"item_004",headerName:"제조사(수입자/병행수입)",editable: true,},
                {field:"item_005",headerName:"제조국",editable: true,},
                {field:"item_006",headerName:"세탁방법 및 취급시 주의사항",editable: true,},
                {field:"item_007",headerName:"제조연월",editable: true,},
                {field:"item_008",headerName:"품질보증기준",editable: true,},
                {field:"item_009",headerName:"A/S 책임자와 전화번호",editable: true,},
                {field:"item_010",headerName:"KC안전인증 대상 유무",editable: true,},
                {field:"item_011",headerName:"수입여부",editable: true,},
                {field:"item_012",headerName:"종류",editable: true, },
        ];
        ...
        function Search(page) {
            let data = $('form[name="search"]').serialize();
            setColumn(page);
            gx.Request('/partner/product/prd05/search', data, page);
        ...
        function setColumn(_page){
            var frm = $('form[name="search"]');
            var min_w = 100;
            var setCol_style = [
                {colId : "goods_type", width:80},
                {colId : "com_nm", width:80},
                {colId : "opt_kind_nm", width:80},
                {colId : "brand_nm", width:100},
                {colId : "style_no", width:80},
                {colId : "goods_nm", width:200},
                {colId : "sale_stat_cl", width:100},
                {colId : "goods_no", width:80},
                {colId : "class", width:100},
            ];
            var setCol = [
                // this row shows the row index, doesn't use any data from the row
                {
                ...
                {field:"goods_type",headerName:"상품구분",minWidth:80,cellStyle:StyleGoodsTypeNM,pinned:'left',editable: true, suppressSizeToFit:true},
                {field:"com_nm",headerName:"업체",pinned:'left',editable: true, },
                {field:"opt_kind_nm",headerName:"품목",pinned:'left', editable: true, },
                {field:"brand_nm",headerName:"브랜드", editable: true,minWidth:100},
                {field:"style_no",headerName:"스타일넘버", editable: true,minWidth:80},
                {field:"img2",headerName:"img2",hide:true},
                {field:"img" , headerName:"이미지",
                    cellRenderer: function(params) {
                        if (params.value !== undefined && params.data.img != "") {
                ...
                {field:"goods_nm" , headerName:"상품명",type:"GoodsNameType",minWidth:200,editable: true,},
                {field:"sale_stat_cl",headerName:"상품상태",minWidth:100,cellStyle:StyleGoodsState},
                {field:"goods_no",headerName:"상품번호", minWidth:80,editable: true,
                    cellRenderer: function(params) {
                        if (params.value !== undefined) {
                            return params.data.goods_no +' ['+ params.data.goods_sub +']';
                        }
                ...
                {field:"goods_sub",headerName:"goods_sub",hide:true},
                {field:"class",headerName:"분류",minWidth:100,editable: true, }
            ];
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(i=0; i<col_cnt; i++){
                        ...
                        */
                        col_val = {field:col_arr[i][0],headerName:col_arr[i][1], editable: true};
                        col_style = {colId : col_arr[i][0], width:100, minWidth:100 };
