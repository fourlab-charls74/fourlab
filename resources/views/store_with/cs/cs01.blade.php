...
@section('content')
            ...
            <div class="card mb-3">
                <div class="d-flex card-header justify-content-between">
                    ...
                    <div>
                        ...
                        <!-- <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary shadow-sm pl-2" onclick="initSearch();" hidden>검색조건 초기화</a> -->
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        var columns= [
            ...
            {field: "req_rt", headerName: "등록일시", width: 130, cellStyle: {"text-align": "center"}},
            {field: "prc_nm", headerName: "처리중", width: 80, cellStyle: {"text-align": "center"}},
            {field: "prc_rt", headerName: "처리중일시", width: 130, cellStyle: {"text-align": "center"}},
            {field: "fin_nm", headerName: "완료", width: 80, cellStyle: {"text-align": "center"}},
            {field: "fin_rt", headerName: "완료일시", width: 130, cellStyle: {"text-align": "center"}},
            {field: "cfm_nm", headerName: "원가확정", width: 80, cellStyle: {"text-align": "center"}},
            {field: "cfm_rt", headerName: "원가확정일시", width: 130, cellStyle: {"text-align": "center"}},
            {field: "rej_nm", headerName: "취소", width: 80, cellStyle: {"text-align": "center"}},
            {field: "rej_rt", headerName: "취소일시", width: 130, cellStyle: {"text-align": "center"}},
            {width: "auto"},
        ];
