...
<div id="search-area" class="search_cum_form">
    <form method="get" name="search">
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                ...
                <div>
                    ...
                    <a href="javascript:void(0);" onclick="openDetailPopup()" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-plus fa-sm text-white-50 mr-1"></i> 매장실사등록</a>
                    <a href="javascript:void(0);" onclick="" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-plus fa-sm text-white-50 mr-1"></i> 매장LOSS등록</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div class="resul_btn_wrap mb-3">
            ...
            <a href="javascript:void(0);" onclick="" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-plus fa-sm text-white-50 mr-1"></i> 매장실사등록</a>
            <a href="javascript:void(0);" onclick="" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-plus fa-sm text-white-50 mr-1"></i> 매장LOSS등록</a>
        </div>
    </form>
</div>
