...
<div class="show_layout py-3 px-sm-3">
    <div class="page_tit d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="d-inline-flex">매장실사 일괄등록</h3>
...
<script language="javascript">
    ...
    let columns = [
        ...
        {field: "goods_sh", headerName: "현재가", type: "currencyType", width: 70},
        {field: "price", headerName: "정상가", type: "currencyType", width: 70},
