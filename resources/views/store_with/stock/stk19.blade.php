...
@section('title','상품출고관리 > 창고출고')
@section('content')
	<div class="page_tit">
		<h3 class="d-inline-flex">창고출고</h3>
		...
		<div id="search-area" class="search_cum_form">
			<div class="card mb-3">
				...
				<div class="card-body">
					...
					<div class="row search-area-ext d-none" hidden>
	...
	<script type="text/javascript" charset="utf-8">
		...
		function Search() {
			...
			gx.Request('/store/stock/stk19/search', data, 1);
		}
		...
		function requestRelease() {
			...
			if(!confirm("해당 상품을 출고처리하시겠습니까?")) return;
			...
			axios({
				url: '/store/stock/stk19/request-release',
				method: 'post',
				data: data,
			}).then(function (res) {
		...
		const openBatchPopup = () => {
			const url = '/store/stock/stk19/batch';
