...
@section('content')
	...
	<div class="show_layout py-3 px-sm-3">
		<div class="page_tit d-flex justify-content-between">
			<div class="d-flex">
				<h3 class="d-inline-flex">창고출고 엑셀 업로드</h3>
										...
										<tr>
											...
											<td class="w-100">
												<div class="flex_box">
													...
													<a href="/sample/sample_stk19.xlsx" class="ml-2" style="text-decoration: underline !important;">창고출고 등록양식 다운로드</a>
												</div>
											</td>
										</tr>
										</tbody>
						...
						<div class="filter_wrap d-flex justify-content-between">
							...
							<div class="d-flex flex-grow-1 flex-column flex-lg-row justify-content-end align-items-end align-items-lg-right">
								...
								<div class="d-flex">
									...
									<a href="#" onclick="requestRelease();" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="fas fa-sm text-white-50"></i>출고</a> &nbsp;&nbsp;
	...
	<script language="javascript">
		...
		let columns = [
			...
			{field: "goods_no", headerName: "온라인코드", pinned: 'left', width: 78, cellStyle: {"text-align": "center"}},
			{field: "opt_kind_nm", headerName: "품목", pinned: 'left', width: 70, cellStyle: {"text-align": "center"}},
			...
			{field: "storage_memo", headerName: "창고메모", editable: true, cellStyle: {'background-color': '#ffff99'}, width : 200},
		];
	</script>
	...
	<script type="text/javascript" charset="utf-8">
		...
		const upload = () => {
			...
			axios({
				method: 'post',
				url: '/store/stock/stk19/batch-import',
				data: form_data,
				headers: {
		...
		const getGood = async (rows, firstIndex) => {
			...
			axios({
				url: '/store/stock/stk19/batch-getgoods',
				method: 'post',
				data: { data: rows },
			}).then(async (res) => {
