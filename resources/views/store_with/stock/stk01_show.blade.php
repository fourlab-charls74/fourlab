...
<script>
    ...
    async function search_storage_stock(data) {
        let res = await axios({ method: "get", url: "/store/stock/stk01/search-stock/storage?" + data });
    ...
    async function search_store_stock(data) {
        let res = await axios({ method: "get", url: "/store/stock/stk01/search-stock/store?" + data });
        let total = res.data.total;
        let list = res.data.data;
    ...
    async function search_store_stock_detail(data) {
        gx3.Request("/store/stock/stk01/search-stock/store-detail", data, -1, async function(d) {
