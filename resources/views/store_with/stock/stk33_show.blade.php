...
@section('title','일별동종업계매출등록')
@section('content')

<div class="py-3 px-sm-3">
    <div class="page_tit">
        <h3 class="d-inline-flex">일별동종업계매출등록</h3>
        <div class="d-inline-flex location">
            <span class="home"></span>
            <span>/ 매장관리</span>
            <span>/ 일별동종업계매출관리</span>
            <span>/ 일별동종업계매출등록</span>
        </div>
    </div>
        ...
        <div id="search-area" class="search_cum_form">
            <div class="card mb-3">
                <div class="d-flex card-header justify-content-between">
                    <h4>기본 정보</h4>
                    <div>
                        <a href="#" id="search_sbtn" onclick="Search();" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-search fa-sm text-white-50 mr-1"></i> 조회</a>
                        <a href="#" id="search_sbtn" onclick="Save_amt();" class="btn btn-sm btn-primary shadow-sm mr-1"><i class="fas fa-save fa-sm text-white-50"></i> 저장</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
            ...
            <div class="resul_btn_wrap mb-3">
                ...
                <a href="#" id="search_sbtn" onclick="Save_amt();" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-save fa-sm text-white-50"></i> 저장</a>    
            </div>
        </div>
    ...
    let columns = [
        ...
        function Search() {
            ...
            if(store_no == '') {
                ...
                gx.Request('/store/stock/stk33/com_search', data, -1, function(e) {
                    formatDate(e);
                });
            }
        }
