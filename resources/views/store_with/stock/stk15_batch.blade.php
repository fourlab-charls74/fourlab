...
<div class="show_layout py-3 px-sm-3">
    <div class="page_tit d-flex justify-content-between">
        <div class="d-flex">
            <h3 class="d-inline-flex">일반출고 엑셀 업로드</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-100">
                                                <div class="flex_box">
                                                    ...
                                                    <a href="/sample/sample_stk15.xlsx" class="ml-2" style="text-decoration: underline !important;">일반출고 등록양식 다운로드</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
...
<script type="text/javascript" charset="utf-8">
    ...
    const upload = () => {
        ...
        axios({
            method: 'post',
            url: '/store/stock/stk15/batch-import',
            data: form_data,
            headers: {
     ...
     function requestRelease() {
            ...
            if(rows.length < 1) return alert("일반출고할 상품을 선택해주세요.");
            ...
            axios({
                url: '/store/stock/stk15/request-release-excel',
                method: 'post',
                data: data,
            }).then(function (res) {
    ...
    const getGood = async (rows, firstIndex) => {
        ...
        axios({
            url: '/store/stock/stk15/batch-getgoods',
            method: 'post',
            data: { data: rows },
        }).then(async (res) => {
