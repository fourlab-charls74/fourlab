                                ...
                                <table class="table incont table-bordered" width="100%" cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-inline">
                                                    <textarea name="comment" id="comment" class="w-100" rows="1" readonly disabled style="background-color:#ccc">{{ @$sr->comment }}</textarea>
                                                </div>
                                            </td>
                                            <th>반품코드</th>
                                            <td>
...
<script type="text/javascript" charset="utf-8">
    ...
    const checkIsEditable2 = (params) => {
        return (now_state == '30') && params.data.hasOwnProperty('isEditable') && params.data.isEditable ? true : false;
    };
