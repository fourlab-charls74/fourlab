...
<div class="show_layout py-3 px-sm-3">
    <div class="page_tit d-flex justify-content-between">
        ...
        <div class="d-flex">
            <a href="javascript:void(0)" onclick="Save()" class="btn btn-primary mr-1">출고완료처리</a>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div class="flex_box form-inline">
                                                    ...
                                                    {{-- <a href="#" class="ml-2" style="text-decoration: underline !important;">일괄등록양식 다운로드</a> --}}
                                                    * 파일형식: TSV(탭으로 분리) - 샘플파일.txt (주문일련번호, 송장번호)
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
