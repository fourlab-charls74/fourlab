    ...
    <div id="search-area" class="search_cum_form">
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                <h4>입력</h4>
                <div>
                    <a href="/store/standard/std11/" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="bx bx-list-ul mr-1"></i>목록</a>
                    <a href="/store/standard/std11/create" class="btn btn-sm btn-primary shadow-sm pl-2"><i class="bx bx-save mr-1"></i>저장</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div class="resul_btn_wrap mb-3">
            ...
            <a href="/store/standard/create" class="btn btn-sm btn-outline-primary shadow-sm pl-2"><i class="bx bx-plus fs-16"></i> 추가</a>
