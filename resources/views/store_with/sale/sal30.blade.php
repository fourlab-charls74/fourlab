...
@section('content')
	...
	<script>
		const columns = [
			...
			{field: "r_stock_state_date",	headerName: "일자",	width: 120,	cellClass: 'hd-grid-code'},
			{field: "location_cd",	headerName: "창고명",	width: 120,	cellClass: 'hd-grid-code'},
			{field: "in_qty",	headerName: "입고",	width: 100, type: "currencyType"},
			{field: "rt_in_qty",	headerName: "이동입고",	width: 100, type: "currencyType"},
			{field: "out_qty",	headerName: "출고",	width: 100, type: "currencyType"},
			{field: "rt_out_qty",	headerName: "이동출고",	width: 100, type: "currencyType"},
	...
	<script type="text/javascript" charset="utf-8">
		...
		function Search() {
			...
			gx.Request('/store/sale/sal30/search', data, 1);
		}
	</script>
