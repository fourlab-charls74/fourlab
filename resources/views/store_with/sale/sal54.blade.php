...
@section('content')
	<div class="page_tit">
		<h3 class="d-inline-flex">[NEW]일별 매출 통계</h3>
		<div class="d-inline-flex location">
			<span class="home"></span>
			<span>/ 매출통계</span>
			<span>/ 일별 매출 통계</span>
			{{-- <!--<span>/ <a href="/store/sale/sal24">이전</a></span>//--> --}}
			...
			<div class="card mb-3">
				<div class="d-flex card-header justify-content-between">
					...
					<div>
						...
						<a href="javascript:gx.Download('일별매출통계_{{ date('YmdH') }}');" class="btn btn-download btn-sm btn-outline-primary shadow-sm mr-1"><i class="bx bx-download fs-16"></i> 엑셀다운로드</a>
	...
	<script type="text/javascript" charset="utf-8">
		...
		function Search() {
			...
			gx.Request('/store/sale/sal54/search', data, -1, function(data) {
