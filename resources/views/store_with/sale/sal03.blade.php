...
<script language="javascript">
	var columns = [
        ...
        {field: "",	headerName: "거래처"},
        {field: "",	headerName: "거래처명"},
        {field: "",	headerName: "상품코드"},
        {field: "",	headerName: "상품명"},
        {field: "",	headerName: "아이템코드"},
        {field: "",	headerName: "행사"},
        {field: "",	headerName: "구분"},
        {field: "",	headerName: "기획"},
        {field: "",	headerName: "구분"},
        ...
        {field: "",	headerName: "총생산입고",
            children: [
                {headerName: "수량", field: "", type: 'numberType'},
                {headerName: "금액", field: "", type: 'currencyType'},
                {headerName: "판매율(%)", field: ""}
            ]
        },
        {field: "",	headerName: "출고",
            children: [
                {headerName: "수량", field: "", type: 'numberType'},
                {headerName: "최초출고일", field: "", type: 'currencyType'},
            ]
        },
        {field: "",	headerName: "총판매",
            children: [
                {headerName: "수량", field: "", type: 'numberType'},
                {headerName: "금액", field: "", type: 'currencyType'},
                {headerName: "판매율(%)", field: ""}
        ...
        {field: "",	headerName: "매장재고"},
        {field: "",	headerName: "창고재고"},
