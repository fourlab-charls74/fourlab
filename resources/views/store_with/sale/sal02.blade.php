	...
	var columns = [
		...
		{field: "",	headerName: "합계",	        width:85,
            children: [
                ...
                {headerName: "소계", field: "sum_dc_amt", type: 'currencyType'}
            ]
        },
        {
            field: "", headerName: "기간",
            children: [
                {field: "", headerName: "1	(일)",headerClass:'hd-grid-red'},
                {field: "", headerName: "2	(월)"},
                {field: "", headerName: "3	(화)"},
                {field: "", headerName: "4	(수)"},
                {field: "", headerName: "5	(목)"},
                {field: "", headerName: "6	(금)"},
                {field: "", headerName: "7	(토)",headerClass:'hd-grid-red'},
                {field: "", headerName: "8	(일)",headerClass:'hd-grid-red'},
                {field: "", headerName: "9	(월)"},
                {field: "", headerName: "10	(화)"},
                {field: "", headerName: "11	(수)"},
                {field: "", headerName: "12	(목)"},
                {field: "", headerName: "13	(금)"},
                {field: "", headerName: "14	(토)",headerClass:'hd-grid-red'},
                {field: "", headerName: "15	(일)",headerClass:'hd-grid-red'},
                {field: "", headerName: "16	(월)"},
                {field: "", headerName: "17	(화)"},
                {field: "", headerName: "18	(수)"},
                {field: "", headerName: "19	(목)"},
                {field: "", headerName: "20	(금)"},
                {field: "", headerName: "21	(토)",headerClass:'hd-grid-red'},
                {field: "", headerName: "22	(일)",headerClass:'hd-grid-red'},
                {field: "", headerName: "23	(월)"},
                {field: "", headerName: "24	(화)"},
                {field: "", headerName: "25	(수)"},
                {field: "", headerName: "26	(목)"},
                {field: "", headerName: "27	(금)"},
                {field: "", headerName: "28	(토)",headerClass:'hd-grid-red'},
                {field: "", headerName: "29	(일)",headerClass:'hd-grid-red'},
                {field: "", headerName: "30	(월)"},
                {field: "", headerName: "31	(화)"}
            ]
        },
