...
@section('content')
	<div class="page_tit">
		<h3 class="d-inline-flex">[NEW]월별 매출 통계</h3>
			...
			<div class="card mb-3">
				<div class="d-flex card-header justify-content-between">
					...
					<div>
						...
						<a href="javascript:gx.Download('월별매출통계_{{ date('YmdH') }}');" class="btn btn-download btn-sm btn-outline-primary shadow-sm mr-1"><i class="bx bx-download fs-16"></i> 엑셀다운로드</a>
					...
					<div class="row">
						...
						<div class="col-lg-4 inner-td" hidden>
							<div class="form-group">
								...
								<div class="form-inline form-radio-box">
									<div class="custom-control custom-radio">
										<input type="radio" name="ord_state" id="ord_state10" value="10" class="custom-control-input" />
										<label class="custom-control-label" for="ord_state10">출고요청</label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" name="ord_state" id="ord_state30" value="30" class="custom-control-input" checked />
	...
	<script language="javascript">
		var columns = [{
			...
			cellRenderer: function(params) {
				...
				return `<a href="/store/sale/sal24?${form_data}&sdate=${params.data.date || ''}" target="_new">${params.value}</a>`;
			},
			pinned: 'left',
			aggSum: "합계",
			aggAvg: "평균"
	...
	<script type="text/javascript" charset="utf-8">
		...
		function Search() {
			...
			gx.Request('/store/sale/sal55/search', data, -1, function(data){
