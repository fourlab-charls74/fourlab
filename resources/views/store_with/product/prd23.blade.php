...
<script type="text/javascript" charset="utf-8">
    ...
    function clickSearchBtn(id){
        curIdx = parseInt(id);
        let url = '/store/product/prd01/choice';
    ...
    function getGoodsInfoByGoodsNo(goods_arr) {
        $.ajax({
            async: true,
            type: 'get',
            url: `/store/product/prd23/goods-info/goods-no`,
            data: { data: goods_arr },
    ...
    function getGoodsinfoByStyleNo(style_arr) {
        ...
        $.ajax({
            async: true,
            type: 'get',
            url: `/store/product/prd23/goods-info/style-no`,
    ...
    function uploadImages() {
        ...
        $.ajax({
            async: true,
            type: 'put',
            url: `/store/product/prd23/upload`,
    ...
    function openProductImageSlider() {
        ...
        var url = '/store/product/prd02/slider?goods_nos=' + goods_nos.map(g => g.goods_no).join(",");
