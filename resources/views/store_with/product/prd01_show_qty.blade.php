...
<div class="show_layout py-3 px-sm-3">
    <div class="page_tit mb-3 d-flex align-items-center justify-content-between">
        ...
        <div>
            <a href="#" class="btn btn-sm btn-primary shadow-sm submit-btn"><i class="bx bx-save mr-1"></i>저장</a>
        </div>
    </div>
    <!-- 상품 세부 정보 -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div id="grid" style="height:calc(100vh - 370px);min-height:200px;idth:100%;" class="ag-theme-balham"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function Search() {
        ...
        gx.Request(`/store/product/prd01/${goods_no}/options`, data, -1);
    }
    ...
    $('.submit-btn').click(function(e){
        ...
        rows.forEach(function(data, idx) {
            ...
            $.ajax({
                async: true,
                type: 'put',
                url: `/store/product/prd01/${goods_no}/in-qty`,
                data: data,
