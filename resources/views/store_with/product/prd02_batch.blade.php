                                        ...
                                        <tr>
                                            ...
                                            <td class="w-100">
                                                <div class="flex_box">
                                                    ...
                                                    <a href="/sample/sample_prd02.xlsx" class="ml-2" style="text-decoration: underline !important;">상품일괄등록양식 다운로드</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
...
<script type="text/javascript" charset="utf-8">
    ...
    const upload = () => {
        ...
        axios({
            method: 'post',
            url: '/store/product/prd02/batch-import',
            data: form_data,
            headers: {
    ...
    const getProducts = async (rows, firstIndex) => {
        ...
        axios({
            url: '/store/product/prd02/batch-getproducts',
            method: 'post',
            data: { data: rows },
        }).then(async (res) => {
    ...
    function save() {
            ...
            axios({
                url: '/store/product/prd02/batch-products',
                method: 'post',
                data: data,
            }).then(function (res) {
