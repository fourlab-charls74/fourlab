        ...
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                ...
                <div>
                    ...
                    <a href="#" class="btn btn-download btn-sm btn-outline-primary shadow-sm pl-2"><i class="bx bx-download fs-16"></i> 엑셀다운로드</a>
...
<script language="javascript">
    ...
    $(document).ready(function() {
		...
		$(".btn-download").on("click", function (e) {
			gx.Download('상품정보관리_{{ date('YmdH') }}.xlsx', { type: 'excel' });
		});
    });
