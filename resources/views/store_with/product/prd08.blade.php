                            ...
                            <div class="prd-image-list row" style="margin:0px 5px;border-bottom:1px solid #dddddd;text-align:center;">
                                @foreach($img_urls as $img_url)
                                    <figure class="p-2" style="width:12%;">
                                        <img src="{{$img_url['img']}}" onClick="location.href='/store/product/prd08/{{$goods_no}}/image?img_ta={{$img_url['kind']}}';" alt="" style="width:100%;border:1px solid #dfdfdf;cursor:pointer;">
...
<!-- script -->
@include('store_with.product.prd08_js')
<!-- script -->
@stop
