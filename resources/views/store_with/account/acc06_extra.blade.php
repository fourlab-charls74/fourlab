...
@section('title','기타재반자료 상세내역 - ' . @$store_nm)
@section('content')
...
<!-- DataTales Example -->
<p class="ml-2">최신자료 반영 후 개발예정입니다.</p>
...
<script type="text/javascript" charset="utf-8">
	...
	function Search() {
		...
		gx.Request('/store/account/acc06/show-extra/search', data, -1);
	}

	function gridDownload() {
		gx.Download("기타재반자료_상세내역_" + "{{ @$store_nm ?? '' }}" + ".csv");
	}
</script>
