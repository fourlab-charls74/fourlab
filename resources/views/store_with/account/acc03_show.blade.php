...
<script type="text/javascript" charset="utf-8">
    ...
    const URL = {
        UPDATE: '/store/account/acc03/show_update',
        REMOVE: '/store/account/acc03/show_delete',
        CLOSE: '/store/account/acc03/show_close'
    }
    ...
    var columns = [
		...
		{field: "goods_no",		headerName: "바코드1"},
		{field: "goods_sub",	headerName: "바코드2"},
    ...
    function Search() {
        ...
        gx.Request(`/store/account/acc03/show_search`, data, -1, () => {
            // callback
        });
    };
