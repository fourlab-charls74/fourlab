...
<form name="search">
    <div class="container-fluid py-3">
        ...
        <div class="page_tit d-flex align-items-center justify-content-between">
            <div>
                <h3 class="d-inline-flex">매장 조회</h3>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="flex_box mt-3">
                                <input type='text' placeholder="매장명 검색" class="form-control form-control-sm search-enter" name='name' value=''>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="utf-8">
    ...
    const columns = [
        ...
        {field: "store_cd", headerName: "매장코드", width: 70, cellRenderer: (params) => `${params.value}`, cellStyle: DEFAULT_STYLE},
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        gx.Request('/store/api/stores/search', data, 1, searchCallback);
    }

    const searchCallback = () => {};

    function selectMember(row) {
        if (confirm("매장명을 추가하시겠습니까?") === false) return;
