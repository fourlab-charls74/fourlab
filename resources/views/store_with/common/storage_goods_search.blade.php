...
<div class="container-fluid py-3">
    <div class="page_tit d-flex align-items-center justify-content-between">
        <div>
            <h3 class="d-inline-flex">창고별 상품 검색 - {{ @$storage->storage_nm }}</h3>
 ...
 */
    const columns = [
        ...
        {field: "opt_kind_cd", headerName: "품목", width:70, cellStyle: {"line-height": "30px"}, hide: true},
        ...
        {field: "storage_qty", headerName: "창고 실재고", width:100, type: 'numberType', cellStyle: {"line-height": "30px"}},
        {field: "storage_wqty", headerName: "창고 보유재고", width:100, type: 'numberType', cellStyle: {"line-height": "30px"}},
        {field: "normal_price", headerName: "정상가", type: 'currencyType', cellStyle: {"line-height": "30px"}, hide: true},
        {field: "goods_sh", headerName: "TAG가", type: 'currencyType'},
    ...
    const Search = () => {
        ...
        data += '&storage_cd=' + storage_cd;
        console.log(storage_cd);
        gx.Request('/store/api/storage-goods', data, 1);
    };
