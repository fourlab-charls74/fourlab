...
<form method="get" name="search">
    <div id="search-area" class="search_cum_form">
        ...
        <div class="card mb-3">
            <div class="d-flex card-header justify-content-between">
                ...
                <div class="flax_box">
                    ...
                    <a href="/store/common/comm01/{{ $store_notice_type }}/create" class="btn btn-sm btn-outline-primary shadow-sm pl-2 mr-1"><i class="bx bx-plus fs-16"></i> 추가</a>
        ...
        <div class="resul_btn_wrap mb-3">
            <a href="#" id="search_sbtn" onclick="Search();" class="btn btn-sm btn-primary shadow-sm mr-1"><i class="fas fa-search fa-sm text-white-50"></i> 조회</a>
            <a href="/store/common/comm01/create" class="btn btn-sm btn-outline-primary shadow-sm pl-2 mr-1"><i class="bx bx-plus fs-16"></i> 추가</a>
    ...
    let columns = [
        ...
        {headerName: "제목", field: "subject", width: 400,
            cellRenderer: function(params) {
                return '<a href="/store/common/comm01/show/' + $('#store_notice_type').val() + '/' + params.data.ns_cd +'" rel="noopener">'+ params.value+'</a>';
            }
        },
...
<script type="text/javascript" charset="utf-8">
    ...
    function Search() {
        ...
        if(notice_type === 'notice'){
            gx.Request('/store/common/comm01/notice/search', data);
        } else {
            gx.Request('/store/common/comm01/vmd/search', data);
        }
    }
