...
class C_PP_CLI
{
  ...
  */
  ...
  public function  mf_gen_trace_no( $site_cd, $ip, $mode )
  {
    if ( $mode == "1" )
    {
  ...
  /* -------------------------------------------------------------------- */
  public function  mf_set_payx_common_data( $name, $val )
  {
    if ( $val != "" )
    {
  ...
  public function  mf_set_payx_card_data( $name, $val )
  {
    if ( $val != "" )
    {
  ...
  public function  mf_set_encx_data( $encx_data, $encx_info )
  {
  ...
  /* -   FUNC  :  지불 처리 함수                                        - */
  /* -------------------------------------------------------------------- */
  public function  mf_do_tx( $trace_no,  $home_dir, $site_cd,
  ...
  {
    return  isset($this->m_res_data[ $name ])? $this->m_res_data[ $name ]:null;
  }
