	...
	public function search(Request $request)
	{
		...
		$sql	= "
			select
				...
				,((pss.wqty + pss.rqty) - ifnull(hst.next_qty, 0) - ifnull(hst.qty, 0) - ifnull(hst.on_qty, 0)) * p.wonga as prev_wonga
				...
				,(
					((pss.wqty + pss.rqty) - ifnull(hst.next_qty, 0) - ifnull(hst.qty, 0) - ifnull(hst.on_qty, 0)) * p.wonga
