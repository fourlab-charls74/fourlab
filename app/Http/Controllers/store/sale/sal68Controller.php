...
/** 매장브랜드별매출분석 */
class sal68Controller extends Controller
{
	public function index(Request $request)
	{
		...
		return view( Config::get('shop.store.view') . '/sale/sal68', $values );
	}
		...
		$sql = "
			...
			from (
				select
				    ...
				    , (w.qty * pw.wonga * if(w.ord_state = 30, 1, -1)) as wonga_amt
					...
					, if(w.ord_state = '30', (o.recv_amt/1.1 - (w.qty * pw.wonga)), (o.recv_amt/1.1 - (w.qty * pw.wonga)) * -1) as margin_amt    
