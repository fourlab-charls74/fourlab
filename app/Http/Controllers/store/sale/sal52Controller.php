...
class sal52Controller extends Controller
{
	public function index()
	{
		...
		return view(Config::get('shop.store.view') . '/sale/sal52', $values);
	}
	...
	public function search(Request $request)
	{
		...
		$sql = "
            select 
                ...
                , (pss.wqty - ifnull(hst.next_qty, 0) - ifnull(hst.qty, 0)) * pw.wonga as prev_wonga
                ...
                , ifnull(hst.storage_in_qty, 0) * pw.wonga as storage_in_wonga
                ...
                , ifnull(store_out_qty, 0) * pw.wonga as store_out_wonga
                ...
                , ifnull(store_return_qty, 0) * pw.wonga as store_return_wonga
                ...
                , (pss.wqty - ifnull(hst.next_qty, 0)) * pw.wonga as term_wonga
