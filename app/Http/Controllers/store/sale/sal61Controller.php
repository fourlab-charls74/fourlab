	...
	public function search(Request $request)
	{
		...
		$sql	= "
			select
				...
				,(sum((pss.wqty + pss.rqty + pss.oqty)) - ifnull(hst.next_qty, 0) - ifnull(hst.qty, 0)) * pw.wonga as prev_wonga
			    ...
			    ,(
			        (sum((pss.wqty + pss.rqty + pss.oqty)) - ifnull(hst.next_qty, 0) - ifnull(hst.qty, 0)) * pw.wonga
