...
class sal39Controller extends Controller
{
	public function index(Request $req)
	{
		...
		return view(Config::get('shop.store.view') . '/sale/sal39', $values);
	}
	...
	public function search(Request $request)
	{
		...
		// 판매채널/매장구분 검색
		if($store_channel != ''){
			$where_common	.= " and s1.store_channel ='" . Lib::quote($store_channel). "'";
		}
		if($store_channel_kind != ''){
			$where_common	.= "and s1.store_channel_kind ='" . Lib::quote($store_channel_kind). "'";
		}
