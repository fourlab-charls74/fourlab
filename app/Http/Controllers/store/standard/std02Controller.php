	...
	public function update_store(Request $request){
		...
		try {
			...
			$values	= [
				...
				'store_nm_eng'			=> $request->input('store_nm_eng')??'',
				// 'store_type'			=> $request->input('store_type'),
				'store_channel'			=> $request->input('store_channel'),
				'store_channel_kind'	=> $request->input('store_channel_kind'),
				'store_area'			=> $request->input('store_area'),
				...
				'shop_yn'				=> $request->input('shop_yn'),
				'consignment_yn'		=> $request->input('consignment_yn'),
				'online_yn'				=> $request->input('online_yn'),
				'wholesale_yn'			=> $request->input('wholesale_yn'),
				'retail_store_sales_yn' => $request->input('retail_store_sales_yn'),
