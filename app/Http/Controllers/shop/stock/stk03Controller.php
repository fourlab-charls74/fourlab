...
class stk03Controller extends Controller
{
    public function index()
	{
        ...
        return view(Config::get('shop.shop.view') . '/stock/stk03', $values);
	}
    ...
    public function create()
    {
        ...
        return view(Config::get('shop.shop.view') . '/stock/stk03_show', $values);
    }
    ...
    public function batch_create()
    {
        ...
        return view(Config::get('shop.shop.view') . '/stock/stk03_batch', $values);
    }
    ...
    */
    ...
    public function show($ord_no, $ord_opt_no = '')
    {
        ...
        return view(Config::get('shop.shop.view') . '/stock/stk03_detail', $values);
    }
