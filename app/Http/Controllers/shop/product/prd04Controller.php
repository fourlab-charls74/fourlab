...
//			} 
	...
	public function batch(){
		...
		return view( Config::get('shop.shop.view') . '/product/prd04_batch', $values);
	}
	...
	public function batch_wonga(){
		...
		return view( Config::get('shop.shop.view') . '/product/prd04_batch_wonga', $values);
	}
	...
	public function batch_store(){
		...
		return view( Config::get('shop.shop.view') . '/product/prd04_batch_store', $values);
	}
