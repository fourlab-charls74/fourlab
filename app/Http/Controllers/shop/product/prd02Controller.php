...
class prd02Controller extends Controller
{
	...
	public function create(Request $request)
	{
		...
		return view( Config::get('shop.shop.view') . '/product/prd02_create',$values);
	}
	...
	public function edit_goods_no($product_code, $goods_no, Request $request){
		...
		return view( Config::get('shop.shop.view') . '/product/prd02_edit',$values);
	...
	public function match_goods_no($product_code, Request $request){
		...
		return view( Config::get('shop.shop.view') . '/product/prd02_edit_match',$values);
	...
	public function batch_create(Request $request){
		...
		return view( Config::get('shop.shop.view') . '/product/prd02_batch_create',$values);
	...
	public function product_upload(Request $request)
	{
		...
		return view( Config::get('shop.shop.view') . '/product/prd02_product_upload',$values);
	}
	...
	public function batch_show()
    {
        ...
        return view(Config::get('shop.shop.view') . '/product/prd02_batch', $values);
    }
