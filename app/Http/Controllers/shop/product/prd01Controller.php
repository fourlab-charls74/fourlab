...
class prd01Controller extends Controller
{
	...
	public function index(Request $request)
	{
		...
		return view(Config::get('shop.shop.view') . '/product/prd01', $values);
	}
    ...
    public function index_choice()
    {
        ...
        return view(Config::get('shop.shop.view') . '/product/prd01_choice', $values);
    }
	...
	public function edit_index(Request $request)
	{
		...
		return view(Config::get('shop.shop.view') . '/product/prd01_edit', $values);
	}
    ...
    public function show_in_qty($no) {
        return view(Config::get('shop.shop.view') . '/product/prd01_show_qty', [
            'goods_no' => $no,
            'goods_sub' => 0
        ]);
    }
	...
	public function create()
	{
		...
		return view(Config::get('shop.shop.view') . '/product/prd01_show',
			[
				'goods_no'		=> '',
				'goods_info'	=> [],
				'md_list'		=> SLib::getMDs(),
	...
	*/
	...
	public function stock($goods_no = 0)
	{
        ...
        return view( Config::get('shop.shop.view') . '/product/prd01_stock', $values);
	}
	...
	*/
	...
	public function index_cont($goods_no) {
		...
		return view(Config::get('shop.shop.view') . '/product/prd01_cont', $values);
	}
