...
namespace App\Http\Controllers\shop\cs;
...
class cs02Controller extends Controller
{
    ...
    public function show($sgr_cd = '') 
    {
        ...
        return view(Config::get('shop.shop.view') . '/cs/cs02_show', $values);
    }
    ...
    {
        $values = [];
        return view(Config::get('shop.shop.view') . '/cs/cs02_batch', $values);
    }
