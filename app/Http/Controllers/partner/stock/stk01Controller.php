...
namespace App\Http\Controllers\partner\stock;
...
class stk01Controller extends Controller
{
    public function index() {
        ...
        return view( Config::get('shop.partner.view') . '/stock/stk01',$values);
    }
    ...
    public function show($goods_no, Request $req) {
        ...
        return view(Config::get('shop.partner.view') . '/stock/stk01_show',
            [
                'sdate' => $sdate,
                'edate' => date("Y-m-d"),
                'goods_no' => $goods_no,
