...
class sal04Controller extends Controller
{
    ...
    public function index() {
        ...
        return view( Config::get('shop.partner.view') . '/sales/sal04',$values);
    }
    ...
    public function search(Request $request){
		...
		$inner_where1 .= " and h.com_id='". Lib::quote($com_id)."' ";
		$inner_where2 .= " and w.com_id='". Lib::quote($com_id)."' ";
        ...
        $sql = /** @lang text */
			...
			select
				...
				, cb.brand_nm, opt.opt_kind_nm, opt.opt_kind_cd, g.style_no, g.goods_nm
			...
			order by opt.opt_seq, gs.code_val,
