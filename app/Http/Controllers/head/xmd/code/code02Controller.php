...
class code02Controller extends Controller
{
	//
	public function index() {
		...
		return view( Config::get('shop.head.view') . '/xmd/code/code02',$values);
	}
	...
	public function show()
	{
		...
		return view( Config::get('shop.head.view') . '/xmd/code/code02_show',$values);
	}
