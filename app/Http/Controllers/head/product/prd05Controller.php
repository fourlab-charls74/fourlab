...
class prd05Controller extends Controller
{
    public function index() {
        ...
        $query = /** @lang text */
            "
			select '' as class, '미분류' as class_nm, (select count(*) from goods where ifnull(class,'') = '' ) as cnt
			union all
			select a.class , a.class_nm, ( select count(*) from goods where class = a.class ) as cnt
			from code_class a
			group by a.class
        ";
        ...
        return view( Config::get('shop.head.view') . '/product/prd05',$values);
    }
    ...
    public function down_excel(Request $request){
        ...
        */
        ...
        return view( Config::get('shop.head.view') . '/product/prd05_excel',[
            'rows' => $result,
            'fields' => $columns_val,
