...
class std01Controller extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        $sql =
            ...
            ";
        $opt = DB::select($sql, array("opt_kind_cd" => $opt_kind_cd));
        // print_r ($conf);
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function () use (&$result, $opt) {
                DB::table('opt')->insert($opt);
            });
            $code = 200;
            $msg = "";
        } catch (Exception $e) {
    ...
    public function update($code, Request $request)
    {
        ...
        try {
            DB::transaction(function () use (&$result, $code, $opt) {
                DB::table('opt')
                    ->where('opt_kind_cd', '=', $code)
                    ->update($opt);
            });
            $code = 200;
            $msg = '';
